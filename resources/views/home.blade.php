    ...
    <div class=" col-md-12 px-4">
        <div class="row flex-lg-row-reverse align-items-center g-5 py-5 justify-content-center">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="/img/page/11399.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
            </div>
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold text-body-emphasis lh-1 mb-3">Welcome to ... <br> Himpuanan Mahasiswa Sistem Informasi</h1>
                <p class="lead" style="text-align: justify;">Temukan potensimu dalam dunia teknologi melalui ikatan yang kuat di Himpunan Mahasiswa Program Studi Sistem Informasi. Mari bergabung untuk menemukan pengalaman baru, memperluas jaringan, dan meraih momen yang tak terlupakan.</p>
    ...
    <div class="container my-5 ">
        <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
            ...
            <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg">
                <img class="rounded-lg-3" src="/img/page/l.png" alt="" width="720">
            </div>
        </div>
    </div>
