...
<div class="table-responsive small col-lg-6">
    <a href="/dashboard/categories/create" class="btn btn-primary mb-3"><i class="bi bi-plus-square"></i> Tambah Kategori</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="/dashboard/categories/{{$category->slug}}/edit" class="badge bg-warning"><i class="bi bi-pencil-square"></i></i></a>
